...
\makeoddhead{appendices}{}{{\color{light-gray} Appendix A}}{}
%
...
\chapter{Fine-grained Access Control in Android Applications}
\label{chap:seapp}
\pagestyle{afterintro}
\input{chapters/seapp.tex}

\chapter{Lightweight Cloud Application Sandboxing}
\label{chap:dmng}
\pagestyle{afterintro}
\input{chapters/dmng.tex}

\chapter{Enhancing the Sandbox of WebAssembly Runtimes}
\label{chap:wasm}
\pagestyle{afterintro}
\input{chapters/wasm.tex}

\chapter{Native Code Sandboxing for JavaScript Runtimes}
\label{chap:natisand}
\pagestyle{afterintro}
