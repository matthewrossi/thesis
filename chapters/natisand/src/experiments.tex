...
\begin{table}[!t]
	...
	\begin{tabular*}{0.85\columnwidth}{ l l l l l}
	  \toprule
...
\begin{table}[!t]
	\centering
    \setlength{\tabcolsep}{3mm}
	\begin{tabular*}{0.63\columnwidth}{l r r r r r}
		\toprule
...
Gbps and 10 ms, respectively, while 100 warm-up requests were carried
...
cost to set up the native sandbox less relevant. It is worth to mention
...
the web application, and (ii) they require understanding in depth the
...
\begin{table}[!t]
	...
	\begin{tabular*}{0.57\columnwidth}{l r r r r}
		\toprule
...
programmatically, and file system privileges work at
