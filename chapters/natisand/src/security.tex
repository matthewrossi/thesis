...
allow constraining how JS code can access system resources.  This is a
...
\paragraph{{File system compromise}}
Guaranteeing the integrity and confidentiality of the application host
file system is crucial to mitigate risks of data corruption and
...
file system restricts what can be read, written or run by an attacker,
...
permission system enforced by JS runtimes able to securely render JS
