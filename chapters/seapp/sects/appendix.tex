\chapter{Practical showcase of \seapp capabilities}\label{appendix:seapp_analysis}

\begin{wrapfigure}{r}{0.29\textwidth}
  \centering
  \includegraphics[width=0.29\textwidth]{chapters/seapp/figs/ae/MainActivity.png}
...
\begin{lstlisting}[
  ...
  aboveskip=4mm, belowskip=1mm, breakatwhitespace=true,
  postbreak=\mbox{{$\hookrightarrow$}\space}, breakindent=1ex,
  captionpos=b
]
...
\begin{lstlisting}[
  ...
  aboveskip=2mm, belowskip=1mm, breakatwhitespace=true,
  postbreak=\mbox{{$\hookrightarrow$}\space}, breakindent=1ex,
  captionpos=b
]
...
\begin{lstlisting}[
  ...
  aboveskip=2mm, belowskip=1mm, captionpos=b
]
