...
which the {\tt cameraserver} service is made accessible to the {\em
  secret} process.  \newline
\begin{lstlisting}[language=policyfile, caption=\bf \seappcontexts
...
\end{lstlisting}
%
\begin{lstlisting}[language=policyfile, caption=\bf \filecontexts
...
\end{lstlisting}
%
\begin{lstlisting}[language=policyfile, caption=\bf Granting \texttt{cameraserver}
