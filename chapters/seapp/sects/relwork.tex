...
middleware and kernel layer policy language.  It is based on User Space
...
object capabilities.  The proposal is interesting as it permits the
achievement of secure compartmentalization between different app
...
compartmentalize third-party libraries from their host app using a separate
