...
\begin{figure}[h!]
  \centering
  \subfloat{\includegraphics[width=0.29\textwidth]{chapters/seapp/figs/ae/UseCase1Activity.png}}
  \hfill
  \subfloat{\includegraphics[width=0.29\textwidth]{chapters/seapp/figs/ae/UsaCase1ActivityExploited.png}}
  \hfill
  \subfloat{\includegraphics[width=0.29\textwidth]{chapters/seapp/figs/ae/UseCase1ActivityNotExploited.png}}
