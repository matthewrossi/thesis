...
systems are the highest\footnote{At the time of writing, US\$2.5M and
  ...
  security of Android and iOS, respectively. }.
...
and on the other hand the need for users to install into the system
numerous applications (called simply {\em apps} in this domain)
