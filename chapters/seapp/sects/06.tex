...
to define the subset of services the domain can use, and to
...
\begin{figure}[t]
	\centering
  \subfloat{\includegraphics[width=0.45\columnwidth]{chapters/seapp/data/three_kinds_basic}}
  \hspace{2em}
  \subfloat{\includegraphics[width=0.45\columnwidth]{chapters/seapp/data/three_kinds_ordinary}}
  \\
  \subfloat{\includegraphics[width=0.45\columnwidth]{chapters/seapp/data/three_kinds_huge}}
...
the overall size in kilobytes of the binary policy.

\begin{figure}[t]
  \centering
  \begin{minipage}[t]{.48\textwidth}
    \centering
    \includegraphics[width=0.95\columnwidth]{chapters/seapp/data/top100_cumulative}
  ...
  \begin{minipage}[t]{.48\textwidth}
    \centering
    \includegraphics[width=0.95\columnwidth]{chapters/seapp/data/overheads}
...
\begin{table}[h!]
	...
	\begin{tabular}{|l|r|r|r|}
		\hline
		\textbf{Policy} & \textbf{\#types} & \textbf{\#avrules} & \textbf{size [KB]} \\ \hline \hline
...
\begin{table}[h]
  ...
  \begin{tabular}{|l|c|c|c|c|c|c|c|c|}
    \cline{1-9}
    \multicolumn{1}{|c|}{\multirow{3}{*}{\textbf{Component}}}&\multicolumn{4}{c|}{\textbf{Cold start
                           [ms]}}&\multicolumn{4}{c|}{\textbf{Warm start [ms]}} \\
    \cline{2-9}
    &\multicolumn{2}{c|}{\textbf{\emph{Stock OS}}}&\multicolumn{2}{c|}{\textbf{\emph{\seapp}}}&\multicolumn{2}{c|}{\textbf{\emph{Stock OS}}}&\multicolumn{2}{c|}{\textbf{\emph{\seapp}}}  \\ \cline{2-9}

    \multicolumn{1}{|c|}{}  & $\mu$ & $\sigma$ & $\mu$ & $\sigma$ & $\mu$ & $\sigma$ & $\mu$ & $\sigma$   \\ \hline \hline
...
\begin{table}[h]
  ...
  \begin{tabular}{|l|c|c|}
    \hline
    \textbf{Test} & \textbf{$\mu$ [\textmu s]} & \textbf{$\sigma$ [\textmu s]} \\ \hline \hline
