...
the benchmarks reported in the coreutils repository, except for
those that are not portable to WASI due to temporary lack
...
runs were performed (with 100 warm-ups). As shown from the results in Table~\ref{table:exp}, our approach introduces
...
\begin{table}[!t]
	...
	\begin{tabular*}{0.83\columnwidth}{l r r r r}
		\toprule
