...
While effective in restricting file system access to an entire
...
that enable finer-grained compartmentalization of cloud applications.
...
\begin{figure}[t!]
  \centering
	\includegraphics[width=0.9\columnwidth]{chapters/wasm/fig/wasi}
