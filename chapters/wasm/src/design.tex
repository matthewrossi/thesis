...
\begin{figure}[t!]
     \centering
     \includegraphics[width=0.8\columnwidth]{chapters/wasm/fig/wasi-bpf}
...
{\tt write} allows the creation and deletion of files within it. We extended the Wasmtime
...
path resolution~\cite{parentfix}, wrong directory
