...
adding, changing and removing requirements. For instance, it allows the
deletion of requirements based on the permission mask (e.g., {\tt
...
application).  After the pruning process terminates, the changes to the
...
components with a per-thread policy, we recommend leveraging this
